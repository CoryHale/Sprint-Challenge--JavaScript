...
*/
const smallerPopulation = zooAnimals.filter(index => index.population < 5);
...
let reducer = (accu, curVal) => accu + curVal.population;

populationTotal = zooAnimals.reduce(reducer, 0);
